...
export class ConfirmationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.post('http://backend-mobikart-alb-2052532502.us-east-1.elb.amazonaws.com/getOrderData', JSON.stringify({ customer: customer_id, puchase_time: time }), { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {
      this.model = res
